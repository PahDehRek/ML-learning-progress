...
My very first repo. Contains all of my ML (and github) learning progress from the very start. Includes course files, mini-projects, and Kaggle competitions.
MAJOR PROJECTS WILL BE A DIFFERENT REPO.
...
4. Finished the __Panda__ course in Kaggle
5. Finished the __Data Cleaning__ course in Kaggle
